            ...
            <div
                ...
                <div class="flex-auto px-0 pt-0 pb-2">
                    <div class="p-0 overflow-x-auto">
                        <table class="items-center w-full mb-0 align-top border-collapsetext-slate-500">
                            ...
                            <tbody>
                                @forelse ($peserta as $item)
                                    <tr>
                                        <td
                                            class="p-2 align-middle bg-transparent border-b-0 whitespace-nowrap shadow-transparent text-center">
                                            1</td>
                                        <td
                                        ...
                                        <td
                                            ...
                                            <p class="mb-0 text-xs font-semibold leading-tight  ">
                                                {{ $item->berkasproject->name_project }}
                                            </p>
                                        ...
                                        <td
                                            ...
                                            <span
                                                class="bg-gradient-to-tl from-slate-600 to-slate-300 px-2.5 text-xs rounded-1.8 py-1.4 inline-block whitespace-nowrap text-center align-baseline font-bold uppercase leading-none text-white">{{ $item->status_contest }}</span>
                                        </td>

                                        <td
                                            class="p-2 align-middle bg-transparent border-b-0 whitespace-nowrap shadow-transparent">
                                            <a href="{{ route('admin.editfinalis', ['id' => $item->id]) }}"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6"
                                            class=" font-semibold p-2 align-middle bg-transparent border-b-0 whitespace-nowrap shadow-transparent text-center">
                                            Data Tidak ada</td>
