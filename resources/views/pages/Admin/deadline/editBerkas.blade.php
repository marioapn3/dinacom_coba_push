    ...
    <div class="w-full max-w-full px-3 mt-0  lg:flex-none">
        <div
            ...
            <div class="flex-auto p-4">
               <form method ="POST" action="{{route('admin.deadlineBerkas.store')}}">
                @method('PUT')
                @csrf
                <div class="relative">
                    <input type="date" name="deadlineBerkas" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 mb-4" value="{{old('deadlineBerkas')??$batasBerkas}}" id="">
