...
<html lang="en" class="scroll-smooth">
  ...
  <body class="font-ubuntu m-0 p-0 overflow-x-hidden w-full bg-darkgreen">
    ...
    >
      <div
        class="container flex flex-wrap flex-end justify-end items-center mx-auto"
      >
        <button
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
          ...
          >
            <li class="nav-menu">
              <a
                href="#header"
                class="bg-transparent block p-2 px-4 text-[1.5em] rounded text-textgreen md: hover:text-white hover:text-white"
                >Beranda</a
              >
            </li>
            <li class="nav-menu">
    ...
    <main class="min-w-[100vw]">
      <section id="header">
        <div
          class="section bg-[url('./assets/images/banner_bg.png')] bg-cover md:min-h-[100vh] pt-36 pb-12"
        >
          <div class="grid md:grid-cols-2 gap-4 container mx-auto">
            <div>
              <h1
                class="text-textgreen font-extrabold lg:text-7xl md:text-5xl text-4xl md:mx-6 font-bold font-ubuntu text-center md:text-left mb-2" id="title_dinacom"
              >
              ...
              <p
                class="text-white xl:text-4xl lg:text-3xl md:text-2xl text-2xl text-justify mx-6 mb-8"
              >
              ...
              <a
                href=""
                class="bg-btngreen mx-auto md:mx-6 my-6 w-3/4 block py-4 pr-4 pl-3 lg:text-4xl md:text-2xl text-2xl text-center mt-2 rounded-[20px] md:border-0 text-white md: hover:text-white hover:bg-[#5ECE9F] hover:text-white md: hover:bg-textgreen"
                >Daftar</a
              >
              <div
                class="w-3/4 mx-auto mb-[100px] md:mx-6 flex justify-center md:justify-start"
              >
            ...
            <div
              class="order-first md:order-last flex justify-center items-center"
            >
      ...
      <section id="about">
        <div
          class="section bg-[url('./assets/images/about_bg.png')] bg-cover pt-12 md:pt-36 pb-10"
        >
          <div class="container mx-auto">
            <div class="mb-[10rem]">
              <h1
                class="text-textgreen font-extrabold lg:text-7xl md:text-5xl text-4xl md:mx-6 font-bold font-ubuntu text-center" data-aos="fade-up"
              >
                Tentang
              </h1>
              <h1
                class="text-lightgrn lg:text-6xl md:text-4xl text-3xl font-ubuntu text-center md:mx-6 mb-2"
                data-aos="fade-down"
              >
                DINACOM
              </h1>
              ...
              <a
                href=""
                data-aos="fade-down"
                class="bg-btngreen mx-auto  my-6 w-3/4 block py-4 pr-4 pl-3 lg:text-4xl md:text-2xl text-2xl text-center mt-2 rounded-[20px] md:border-0 text-white md: hover:text-white hover:bg-[#5ECE9F] hover:text-white md: hover:bg-textgreen"
                >Guidebook</a
              >
            </div>
            <div class="mx-auto md:mb-[10rem] mb-[5rem]">
              ...
              <div class="flex flex-wrap  w-11/12 mx-auto items-center gap-2">
                ...
                <div class="mx-auto lg:order-2 order-1 border-4 border-textgreen rounded-lg p-8  duration-1000   transition hover:scale-105 hover:bg-medgrn/75" data-aos="flip-left">
                  <h1
                    class="text-center text-4xl md:text-5xl text-textgreen rounded-lg"
                  >
                    Juara 1
                  </h1>
                  <hr class="border-2 md:border-4 border-textgreen mx-auto mb-2" />
                  <h1
                    class="text-center text-4xl md:text-6xl text-white rounded-lg"
                  >
                    2.000.000
                  </h1>
                  <p
                    class="text-left text-2xl md:text-3xl text-white rounded-lg"
                  >
                    <span
                      ><i
                        class="fas fa-circle text-lg md:text-xl text-textgreen"
                      ></i
                    ></span>
                    Sertifikat
                  </p>
                </div> 
                <div class="mx-auto lg:order-1 order-2 border-4 border-textgreen rounded-lg p-8  duration-1000   transition hover:scale-105 hover:bg-medgrn/75" data-aos="flip-left">
                  <h1
                    class="text-center text-4xl md:text-5xl text-textgreen rounded-lg"
                  >
                    Juara 2
                ...
                <div class="mx-auto lg:order-3 order-3 border-4 border-textgreen rounded-lg p-8  duration-1000   transition hover:scale-105 hover:bg-medgrn/75" data-aos="flip-left">
                  <h1
                    class="text-center text-4xl md:text-5xl text-textgreen rounded-lg"
                  >
                    Juara 3
            ...
            <div class="mx-auto mb-[10rem]">
              <h1
                class="text-lightgrn text-[3rem] md:text-[5rem] font-ubuntu text-center" data-aos="fade-up"
              >
                Timeline
              </h1>
              ...
              <div class="container">
                <div
                  class="flex flex-col md:grid grid-cols-12 text-gray-50 mx-8"
                >
                  <div class="flex md:contents">
                    ...
                    >
                      <div class="h-full w-6 flex items-center justify-center">
                        <div
                          class="h-full top-2 w-1 bg-btngreen pointer-events-none"
                        ></div>
                      </div>
                      <div
                    ...
                    >
                      <h3
                        class="font-ubuntu text-[1.4rem] md:text-[2rem] mb-1 drop-shadow"
                      >
                        Pembukaan Pendaftaran
                      </h3>
                      <p
                        class="leading-tight text-[1.2rem] md:text-[1.25rem] text-justify"
                      >
                        1 Desember 2022
                      </p>
                    </div>
          ...
          <div class="container mx-auto">
            ...
            <div class="flex flex-wrap justify-center">
              <div class="medpartImg m-8"  data-aos="flip-left">
                <img
                  src="./assets/images/medpart.png"
                  class="md:w-[12.5rem] md:h-[12.5rem] w-[5rem] h-[5rem]"
                  alt=""
                />
              </div>
              <div class="medpartImg m-8" data-aos="flip-left">
      ...
      <section id="sponsor">
        <div
          class="section bg-[url('./assets/images/banner_bg.png')] py-12 md:py-24"
        >
          <div class="container mx-6 md:mx-auto">
            ...
            <div class="grid grid-cols-2 gap-2 md:w-8/12 mx-auto mb-4">
              <div class="spons flex" data-aos="fade-left">
                <img
                  src="./assets/images/sponsplacehold.png"
                  class="md:w-[3.125rem] md:h-[3.125rem] w-[1.5rem] h-[1.5rem] mr-2"
                  alt=""
                />
          ...
          <div class="grid md:grid-cols-2 gap-2">
            ...
            <div class="" data-aos="fade-left">
              ...
              <div class="mb-6 md:mb-0 flex justify-start">
                <a
                  href="http://dncc-semarang.dinus.ac.id/"
                  class="flex items-center"
                >
                  <img
                    src="./assets/images/logodncc.png"
                    class="mr-3 md:h-[200px] h-[150px]"
                  />
                </a>
                <a href="https://www.dinus.ac.id/" class="flex items-center">
                  <img
                    src="./assets/images/logoudinus.png"
                    class="mr-3 md:h-[200px] h-[150px]"
                  />
                </a>
              </div>
      ...
      <div class="relative p-4 w-full max-w-md h-full md:h-auto">
        ...
        <div class="relative bg-darkgreen rounded-lg shadow">
          ...
          <div class="py-6 px-6 lg:px-8">
            ...
            <div id="myTabContent">
              <div
                class="p-4 bg-medgrn rounded-lg"
                id="login"
                role="tabpanel"
